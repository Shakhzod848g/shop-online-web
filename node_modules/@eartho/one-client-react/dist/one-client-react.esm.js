 ...
 * The Eartho Context
 */
var EarthoOneContext = createContext(initialContext);
...
var EarthoOneProvider = function (opts) {
    ...
    var client = useState(function () { return new EarthoOne(toEarthoOneOptions(clientOpts)); })[0];
    ...
    var connectWithRedirect = useCallback(function (opts) {
        deprecateRedirectUri(opts);
        return client.connectWithRedirect(opts);
    }, [client]);
    var connectWithPopup = useCallback(function (options, config) { return __awaiter(void 0, void 0, void 0, function () {
        var error_2, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var getUser = useCallback(function () { return client.getUser(); }, [client]);
    var getIdToken = useCallback(function () { return client.getIdToken(); }, [client]);
...
export { AuthenticationError, EarthoOneContext, EarthoOneProvider, GenericError, InMemoryCache, LocalStorageCache, MfaRequiredError, OAuthError, PopupCancelledError, PopupTimeoutError, TimeoutError, User, initialContext, useEarthoOne, withAuthenticationRequired, withEarthoOne };
