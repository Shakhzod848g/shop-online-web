...
import { EarthoOneOptions, User } from '@eartho/one-client-js';
import { EarthoOneContextInterface } from './eartho-context';
/**
 ...
 */
declare const EarthoOneProvider: (opts: EarthoOneProviderOptions) => JSX.Element;
export default EarthoOneProvider;
//# sourceMappingURL=eartho-provider.d.ts.map